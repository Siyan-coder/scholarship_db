...
<body class="auth-page">
    ...
    <div class="login-card">
        ...
        <form method="POST">
            ...
            <button type="submit" name="login" class="btn-action full-width">Login</button>
        </form>

        <div class="login-footer">
            <p>Don't have an account? <a href="javascript:void(0)" id="openRegModal" style="color: #2ecc71; font-weight: bold; text-decoration: none;">Register here</a></p>
        </div>
    </div>
        ...
        <div class="modal-content register-modal-content">
            ...
            <div class="modal-body">
                <?php if (!empty($reg_errors)): ?>
                    <div class="error-msg">
                        <?php foreach ($reg_errors as $err) echo "<div>$err</div>"; ?>
                    </div>
                <?php endif; ?>
                ...
                <form method="POST">
                    ...
                    <button type="submit" name="register" class="btn-primary full-width">Create Account</button>
                </form>
            </div>
        </div>
    </div>
